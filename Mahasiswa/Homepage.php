    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu">
            <a class="dropdown-item" href="Perpanjangan.php">Pendaftaran Perpanjangan Waktu TA</a>
  ...
  <div class="row-original">
    <div class="left-box code" data-aos="fade-left" data-aos-duration="1500">
      <a class="linklink" href="TA.php">
        ...
        <div class="row-1 h5">
            Pendaftaran Form Mahasiswa Ujian Tugas Akhir
        </div>
      </a>
    </div>
    <div class="right-box code" data-aos="fade-right" data-aos-duration="1500">
      <a class="linklink" href="Perpanjangan.php">
        <div class="row-1 h2">
            Pendaftaran Perpanjangan Tugas Ujian Akhir
        </div>
        <div class="row-1 h5">
            Pendaftaran Perpanjangan Form Mahasiswa Ujian Tugas Akhir
        </div>
      </a>
    </div>
  </div>
